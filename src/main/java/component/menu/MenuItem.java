...
public class MenuItem extends JPanel {
    ...
    public MenuItem(Menu menu, String[] menus, int menuIndex, java.util.List<MenuEvent> events) {
        this.menu = menu;
        this.menus = menus;
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("main/resources/images/menuItem/" + menuIndex + ".svg");
    ...
    private void init() {
        ...
        this.putClientProperty(FlatClientProperties.STYLE, "background:$Menu.background;"
    ...
    public void setExpand(boolean full) {
        if (full) {
            int size = getComponentCount();
            for (int i = 0; i < size; i++) {
                Component com = getComponent(i);
