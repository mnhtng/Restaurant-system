...
public class PopupSubmenu extends JPanel {
    ...
    private void init() {
        ...
        this.putClientProperty(FlatClientProperties.STYLE, "border:0,3,0,3;"
    ...
    // Show the popup menu at a specific location relative to a component.
    ...
    private void applyAlignment() {
        this.setComponentOrientation(menu.getComponentOrientation());
    ...
    // Highlight the selected button in the submenu.
